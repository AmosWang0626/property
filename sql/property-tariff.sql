...
CREATE TABLE `tariff_bill`  (
  ...
  `HOUSE_NO` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '户号',
  ...
  `LEVEL` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '缴费标准等级',
  ...
  `BILL_MONTH` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '账单月份',
  `BILL_STATUS` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '账单状态',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10000 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '缴费账单表' ROW_FORMAT = Compact;
...
CREATE TABLE `tariff_bill_plan`  (
  ...
  `UPDATE_TIME` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `CREATE_TIME` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`PLAN_NO`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '缴费账单还款计划表' ROW_FORMAT = Compact;
...
CREATE TABLE `tariff_company`  (
  ...
  `ADDRESS` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公司地址',
  `TELEPHONE` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公司联系方式',
  `ORGANIZATION_CODE` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '组织机构代码',
  `LEGAL_NAME` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '企业法人名字',
  `ESTABLISH` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '成立时间',
  `REGISTER_CAPITAL` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '注册资金',
  `STATUS` tinyint(1) NOT NULL COMMENT '状态(1:正常;0:无效)',
  `UPDATE_TIME` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `CREATE_TIME` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`COMPANY_ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1000000 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收费公司信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `tariff_company_bill`  (
  ...
  `ERROR_MESSAGE` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '错误信息',
  `CREATE_TIME` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收费公司账目表' ROW_FORMAT = Compact;
...
CREATE TABLE `tariff_consume` (
  ...
  `CONSUME_EXPAND` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '消费备注',
  `PAYMENT_STATUS` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '支付状态',
  `EXPAND` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '拓展字段',
  `UPDATE_TIME` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `CREATE_TIME` datetime NOT NULL COMMENT '创建时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '缴费标准表' ROW_FORMAT = Compact;
